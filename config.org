...
- [[#main-configuration-file][Main Configuration file]]
  ...
  - [[#defaults][Defaults]]
    ...
    - [[#save-desktop-session][Save desktop session]]
  - [[#features][Features]]
    - [[#icons][Icons]]
...
(use-package org
  ...
  (setq org-startup-indented              t             ;; indent text to heading level
        ...
        org-todo-keywords                 '((sequence "TODO" "☛ NEXT" "PAUSE" "REVIEW" "|" "✔ DONE" "✘ CANCEL"))  ;; default todo keywords
        ...
        org-agenda-prefix-format          '((agenda . " %i %-21:c%?-21t% s")    ;; make the first column in agenda wider (from 12 characters to 21)
                                            (todo . " %i %-12:c")
                                            (tags . " %i %-12:c")
                                            (search . " %i %-12:c"))
        )
...
(pretty-hydra-define hydra-open
  (:color teal :quit-key "q"  :title "Open Hydra")
  ("Dashboard"
...
(pretty-hydra-define hydra-search
  ...
  ("Search string in buffer (regex)"
   ...
   (("f" find-name-dired "locate files"))
   "Project"
...
(pretty-hydra-define hydra-insert
  ...
  ("Timestamp"
   (("tt" org-time-stamp "prompt for date/time")
    ("ts" org-schedule "prompt for date/time and insert \"scheduled\" string")
    ("td" org-deadline "prompt for date/time and insert \"deadline\" string"))
   ))
#+END_SRC
...
This is used to assign certain variables to certain directories. It is also possible to evaluate functions at startup.
