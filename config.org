...
- [ ] counsel-find-file should show folders before files
...
- [ ] make a hydra for my/org-latex-compile-and-open-pdf, org-sort, and org-goto
- [ ] make pdf-tools work with scroll-other-window (M-<page_up/down>)
- [ ] do something about keybinds that put the cursor in the center/top of the screen
...
- [ ] make untitled buffers appear in the 'All files' bufler group, and also in the respective project subgroup, if it exists
...
(use-package org-superstar
  ...
  ;; (org-superstar-headline-bullets-list '("✙" "♱" "♰" "☥" "✞" "✟" "✝" "†" "✠" "✚" "✜" "✛" "✢" "✣" "✤" "✥"))
  ;; (org-superstar-headline-bullets-list '("◉" "◈" "●" "○" "●" "○" "●" "○"))
  ;; (set-face-attribute 'org-superstar-header-bullet nil :height 2.5 :foreground "#ff0000")
